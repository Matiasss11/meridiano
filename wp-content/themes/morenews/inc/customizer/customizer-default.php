...
function morenews_get_default_theme_options() {
    ...
    $defaults['aft_custom_title']           = __('Vivo', 'morenews');
    ...
    $defaults['flash_news_title'] = __('Exclusivo', 'morenews');
    ...
    $defaults['main_banner_news_section_title'] = __('Noticias Principales', 'morenews');
    ...
    $defaults['latest_tab_title'] = __('Ultimas', 'morenews');
    $defaults['popular_tab_title'] = __('Populares', 'morenews');
    $defaults['trending_tab_title'] = __('Tendencias', 'morenews');
    $defaults['select_trending_tab_news_category'] = 0;

    $defaults['main_trending_news_section_title'] = __('Tendencias de ahora', 'morenews');
    ...
    $defaults['main_latest_news_section_title'] = __('Ultimas', 'morenews');
    ...
    $defaults['featured_news_section_title'] = __('Publicaciones Destacadas', 'morenews');
    ...
    $defaults['global_read_more_texts'] = __('Leer más...', 'morenews');
    ...
    $defaults['sidebar_social_contacts_section_title'] = __('Conectate con Nosotros','morenews');
    ...
    $defaults['sidebar_popular_post_section_title_text'] = __('Noticias Populares','morenews');
    ...
    $defaults['frontpage_latest_posts_section_title'] = __('Es posible que te hayas perdido', 'morenews');
    $defaults['frontpage_latest_posts_category'] = 0;
    $defaults['number_of_frontpage_latest_posts'] = 4;

    $defaults['footer_copyright_text'] = esc_html__('Copyright &copy; Todos los derechos reservados.', 'morenews');
